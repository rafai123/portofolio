      ...
      <section id="about-me">
        <div className="w-full min-h-[100vh] px-7 py-7">
          <div className="max-w-3xl w-full mx-auto gap-2">
            ...
            <BlurFade inView>
              <p className="text-lg text-justify leading-relaxed tracking-wide text-gray-300">
            ...
            <BlurFade inView>
              <p className="text-lg text-justify leading-relaxed tracking-wide text-gray-300 mt-4">
            ...
            <BlurFade inView>
              <p className="text-lg text-justify leading-relaxed tracking-wide text-gray-300 mt-4">If you&apos;d like to connect or work together, feel free to reach out! Let&apos;s create something amazing.</p>
            </BlurFade>
